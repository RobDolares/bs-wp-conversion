...
function bs2wp_register_theme_menus() {
  register_nav_menus(
    array(
...
add_action( 'init', 'bs2wp_register_theme_menus');
function bs2wp_theme_styles() {
...
add_action( 'wp_enqueue_scripts', 'bs2wp_theme_styles');
function bs2wp_theme_js() {
...
add_action( 'wp_enqueue_scripts', 'bs2wp_theme_js');
 ?>
